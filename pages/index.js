    ...
    <>
      ...
      <header className="z-50 bg-one-primary absolute flex justify-center items-center h-screen">
        <div className="flex h-screen w-5/12 justify-between items-center z-20">
          <img src="./hero.jpg" className="w-5/6 z-20" />
        </div>
        <div className="hero-lines bg-white rounded z-20 flex h-[70vh] w-5/12 justify-center items-center drop-shadow-md">
          <div>
            <p className="pb-6 md:text-3xl md:font-semibold z-20 italic text-lg capitalize"><span className="md:text-4xl md:font-bold">E</span>xtend your<br /> management possibilities </p>
            <button onClick={scrollToMain} className="btn text-one-primary duration-500 z-20 bg-white w-3/6 hover:drop-shadow-md hover:bg-one-primary hover:text-white hover:border-one-primary ">Get Started</button>
          </div>
        </div>
      </header>
      <div className="min-h-screen"></div>
      <section className="lg:mx-32 lg:px-10 md:p-5 flex items-center p-2 ">
        <div className="container px-6 py-8 mx-auto">
          <div>
            <div className="flex mb-10 gap-x-5 items-center justify-center" >
              <div className="h-1 w-2/6 bg-one-primary"></div>
              <h1 className="text-6xl uppercase font-bold font-heading text-one-primary py-4 lg:text-left ">About Us
              </h1>
              <div className="h-1 w-2/6 bg-one-primary"></div>
            </div>
          </div>
        ...
        <div className="container px-6 py-8 mx-auto">
          <div className="items-center lg:justify-between lg:flex ">
            <div className="lg:w-6/6 text-lg">
              <div className="flex items-center justify-center">
                <div className="h-1 w-2/6 bg-white"></div>
                <h1 className="text-6xl px-10 text-center uppercase font-bold font-heading text-white py-4 lg:text-left ">Why us?
                </h1>
                <div className="h-1 w-2/6 bg-white"></div>
              </div>
              <div className="grid mx-10 mt-20 gap-y-10 grid-cols-12 grid-rows-3 text-white">
                <div className="flex col-span-6 col-start-1 items-center justify-start mb-3 text-justify">
                  <svg className="w-36" xmlns="http://www.w3.org/2000/svg" height="48" width="48"><path className="fill-white" d="M24 44Q19.75 44 16.1 42.475Q12.45 40.95 9.75 38.25Q7.05 35.55 5.525 31.9Q4 28.25 4 24Q4 19.8 5.525 16.15Q7.05 12.5 9.75 9.8Q12.45 7.1 16.1 5.55Q19.75 4 24 4Q27.75 4 31 5.2Q34.25 6.4 36.85 8.5L34.7 10.65Q32.5 8.9 29.8 7.95Q27.1 7 24 7Q16.75 7 11.875 11.875Q7 16.75 7 24Q7 31.25 11.875 36.125Q16.75 41 24 41Q31.25 41 36.125 36.125Q41 31.25 41 24Q41 22.5 40.775 21.075Q40.55 19.65 40.1 18.3L42.4 16Q43.2 17.85 43.6 19.85Q44 21.85 44 24Q44 28.25 42.45 31.9Q40.9 35.55 38.2 38.25Q35.5 40.95 31.85 42.475Q28.2 44 24 44ZM21.05 33.1 12.8 24.8 15.05 22.55 21.05 28.55 41.75 7.85 44.05 10.1Z" /></svg>
                  <h2>Extala understands the capabilities and functional capacity of Microsoft Power Platform and Microsoft Dynamics 365 to its full extent.</h2>
                </div>
                <div className="flex col-span-6 col-start-4  items-center justify-start mb-3 text-justify">
                  <svg className="w-36" xmlns="http://www.w3.org/2000/svg" height="48" width="48"><path className="fill-white" d="M24 44Q19.75 44 16.1 42.475Q12.45 40.95 9.75 38.25Q7.05 35.55 5.525 31.9Q4 28.25 4 24Q4 19.8 5.525 16.15Q7.05 12.5 9.75 9.8Q12.45 7.1 16.1 5.55Q19.75 4 24 4Q27.75 4 31 5.2Q34.25 6.4 36.85 8.5L34.7 10.65Q32.5 8.9 29.8 7.95Q27.1 7 24 7Q16.75 7 11.875 11.875Q7 16.75 7 24Q7 31.25 11.875 36.125Q16.75 41 24 41Q31.25 41 36.125 36.125Q41 31.25 41 24Q41 22.5 40.775 21.075Q40.55 19.65 40.1 18.3L42.4 16Q43.2 17.85 43.6 19.85Q44 21.85 44 24Q44 28.25 42.45 31.9Q40.9 35.55 38.2 38.25Q35.5 40.95 31.85 42.475Q28.2 44 24 44ZM21.05 33.1 12.8 24.8 15.05 22.55 21.05 28.55 41.75 7.85 44.05 10.1Z" /></svg>
                  <h2>An experienced, committed and well equipped team which understands the platform and its applications well to deliver the best results.</h2>
                </div>
                <div className="flex col-span-6 col-start-7 items-center justify-start mb-3 text-justify">
                  <svg className="w-40" xmlns="http://www.w3.org/2000/svg" height="48" width="48"><path className="fill-white" d="M24 44Q19.75 44 16.1 42.475Q12.45 40.95 9.75 38.25Q7.05 35.55 5.525 31.9Q4 28.25 4 24Q4 19.8 5.525 16.15Q7.05 12.5 9.75 9.8Q12.45 7.1 16.1 5.55Q19.75 4 24 4Q27.75 4 31 5.2Q34.25 6.4 36.85 8.5L34.7 10.65Q32.5 8.9 29.8 7.95Q27.1 7 24 7Q16.75 7 11.875 11.875Q7 16.75 7 24Q7 31.25 11.875 36.125Q16.75 41 24 41Q31.25 41 36.125 36.125Q41 31.25 41 24Q41 22.5 40.775 21.075Q40.55 19.65 40.1 18.3L42.4 16Q43.2 17.85 43.6 19.85Q44 21.85 44 24Q44 28.25 42.45 31.9Q40.9 35.55 38.2 38.25Q35.5 40.95 31.85 42.475Q28.2 44 24 44ZM21.05 33.1 12.8 24.8 15.05 22.55 21.05 28.55 41.75 7.85 44.05 10.1Z" /></svg>
                  <h2>Training employees to give their best, Extala can also assists in training your employees as well. In order to provide a seamless transition of using the platform.</h2>
                </div>
              </div>
            </div>
          </div>
      ...
      <section className="lg:my-20 lg:px-10 lg:mx-20 md:mx-10 md:p-5 p-2 containerOne bg-one-primary rounded-lg">
        <div className="container px-6 py-8 mx-auto">
          <div className="items-center gap-10 text-xl text-white ">
            ...
            <div className="grid grid-cols-3 my-20 justify-items-center items-center grid-rows-2 gap-x-4 text-base">
              <div>
